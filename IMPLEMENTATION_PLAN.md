...
- **Phase 6 — IN PROGRESS (2026-07-27):** room/dungeon foundation — Door data model added to Room, RoomManager (room loading, transition detection, callback), greybox_combat room with door connections, room transition wired in PlaytestScene. Remaining: floor assembly from FloorGraph, procedural room selection, full floor traversal test.
